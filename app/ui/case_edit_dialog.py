...
# ─────────────────────────────────────────────
#  ユーティリティ関数・データ定義（damper_field_data.pyに分離）
# ─────────────────────────────────────────────
from app.ui.damper_field_data import (
    short_path as _short_path,
    type_badge as _type_badge,
    DAMPER_FIELD_HINTS as _DAMPER_FIELD_HINTS,
    get_damper_field_labels as _get_damper_field_labels,
    get_damper_field_units as _get_damper_field_units,
)
