...
from app.ui.minimizer_dialog_actions import _MinimizerResultActionsMixin
...
class MinimizerDialog(_MinimizerResultActionsMixin, QDialog):
    """ダンパー本数最小化ダイアログ。"""
    ...
    # エクスポート・適用メソッドは _MinimizerResultActionsMixin に分離:
    # _export_csv, _export_html_report, _copy_result, _apply_result_to_s8i
