...
from .optimizer_search import _SearchAlgorithmsMixin, _ensure_imports as _ensure_search_imports


class _OptimizationWorker(_SearchAlgorithmsMixin, QThread):
    ...
    # 探索アルゴリズム (_run_*_search, _latin_hypercube_sample) は
    # _SearchAlgorithmsMixin (optimizer_search.py) から継承
